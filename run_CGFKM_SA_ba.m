...
function fitness = sa_fitness(params, X, Y, nCluster, knn_size, nOrder, TXs, A1)
...
x0 = rand(1, nCluster);
[Best_centroid, Best_score1] = simulannealbnd(@(params) sa_fitness(params, X, Y, nCluster, knn_size, nOrder, TXs, A1), ...
    x0, LB, UB, sa_options);
