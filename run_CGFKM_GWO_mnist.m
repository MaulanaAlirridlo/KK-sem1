...
function fitness = gwo_fitness(params, X, Y, nCluster, knn_size, nOrder, TXs, A1)
...
[Best_score1, Best_centroid, ~] = GWO(SearchAgents_no, Max_iter, LB, UB, dim, ...
    @(params) gwo_fitness(params, X, Y, nCluster, knn_size, nOrder, TXs, A1));
