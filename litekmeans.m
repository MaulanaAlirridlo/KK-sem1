...
pnames = {   'distance' 'start'   'maxiter'  'replicates' 'onlinephase' 'clustermaxiter' 'initCentroid'};
dflts =  {'sqeuclidean' 'sample'       []        []        'off'              []               0       };
[eid,errmsg,distance,start,maxit,reps,online,clustermaxit,initCentroid] = getargs(pnames, dflts, varargin{:});
if ~isempty(eid)
